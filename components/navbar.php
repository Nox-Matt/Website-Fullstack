    ...
    <div class="container-fluid">
        <a class="brand navbar-brand space" href="../index.php">
            <img class="controller"
                ...
                width="30" height="24" class="d-inline-block align-text-top">&nbspWelcome Back Admin</a>
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">
                    ...
                    if (isset($_SESSION["id"]) == null || 0) {
                        ...
                        echo "Welcome Back ! Admin, ", $user["name"];
                    }
                    ?>
                </h5>
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../frontend/adminDashboard.php#usersDatabase">User Database</a>
                    </li>
                    <li class="nav-item">
