<?php include '../functions/headSuperAdmin.php';
@$id = $_SESSION["id"];
    ...
    <div class="container-fluid">
        <a class="brand navbar-brand space" href="../index.php">
            <img class="controller"
                ...
                width="30" height="24" class="d-inline-block align-text-top">&nbspWelcome Back Super Admin</a>
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar"
            ...
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasDarkNavbarLabel">
                    ...
                    if (isset($_SESSION["id"]) == null || 0) {
                        ...
                        echo "Welcome Back ! Super Admin, ", $user["name"];
                    }
                    ?>
                </h5>
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../frontend/dashboard.php">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../frontend/news.php">Gallery Handling</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../frontend/dashboard#usersDatabase.php">User Database</a>
                    </li>
                    <li class="nav-item">
