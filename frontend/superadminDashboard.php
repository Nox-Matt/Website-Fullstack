...
require '../functions/headSuperAdmin.php';
if (isset($_SESSION['id']) == null || 0 || ["clearance"] == "User" || ["clearance"] == "Admin") {
...
<head>
    ...
    <?php include '../components/navbarSuperAdmin.php'; ?>
</head>
<br>
<br>
<br>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="userForm">
                    ...
                    <div class="form-outline form-dark mb-4">
                        ...
                        <select name="clearance" id="clearance" class="form-select form-control">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-outline-dark px-5" id="saveUser">Save</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    const url = "../backend/users_data.php";
        ...
        $.ajax({
            ...
            content += "<td>" + users_data[x]["password"] + "</td>";
